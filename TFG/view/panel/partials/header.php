            ...
            <div class="row">
                ...
                <?php if (isset($_SESSION["usuario"])) { ?>
                    <nav id="navbar" class="col-7 navbar navbar-expand-md justify-content-center">
                        <div class="m_left2 navbar-collapse collapse justify-content align-items-center">
                            <ul class="navbar-nav mx-auto text-center">
                                ...
                                <?php if ($_SESSION["usuario"]->admin == 1) { ?>
                                    <li class="nav-item my-auto">
                                        <a class="nav-link" href="<?php echo $_SESSION["home"] ?>panel/noticias">Editar Noticias</a>
                                    </li>
                                    <li class="nav-item my-auto">
                                        <a class="nav-link" href="<?php echo $_SESSION["home"] ?>panel/usuarios">Editar Usuarios</a>
                                    </li>
                                <?php } ?>
                                <?php if ($_SESSION["usuario"]->admin == 0) { ?>
                                    <li class="nav-item my-auto">
                                        <a class="nav-link" href="<?php echo $_SESSION["home"] ?>panel/usuarios/editar/<?php echo $_SESSION["usuario"]->id ?>">Editar datos</a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
