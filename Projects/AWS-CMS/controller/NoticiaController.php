    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            if ($id == "nuevo"){
                ...
                ($consulta > 0) ?
                    $this->view->mensaje("success","La noticia <strong>$titulo</strong> se creado correctamente.", "panel/noticias") :
                ...
                //Mensaje y redirección
                ($consulta > 0) ?
                    $this->view->mensaje("success","La noticia <strong>$titulo</strong> se ha actualizado correctamente.".$texto_img, "panel/noticias") :
        ...
        if ($resultado){
            ...
            if ($noticia->activo == 1){
                ...
                ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                    $this->view->mensaje("success","La noticia <strong>$noticia->titulo</strong> se ha desactivado correctamente.", "panel/noticias") :
                    $this->view->mensaje("danger","Hubo un error al guardar en la base de datos.", "panel/noticias");
            }
            else{
                //Activo la noticia
                ...
                //Mensaje y redirección
                ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                    $this->view->mensaje("success","La noticia <strong>$noticia->titulo</strong> se ha activado correctamente.", "panel/noticias") :
                    $this->view->mensaje("danger","Hubo un error al guardar en la base de datos.", "panel/noticias");
            }
        }
    }
    ...
    public function home($id){
        ...
        if ($resultado){
            ...
            if ($noticia->home == 1){
                ...
                //Mensaje y redirección
                ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                    $this->view->mensaje("success","La noticia <strong>$noticia->titulo</strong> no saldrá en la home.", "panel/noticias") :
                    $this->view->mensaje("danger","Hubo un error al guardar en la base de datos.", "panel/noticias");
            }
            else{
                ...
                //Mensaje y redirección
                ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                    $this->view->mensaje("success","La noticia <strong>$noticia->titulo</strong> saldrá en la home.", "panel/noticias") :
                    $this->view->mensaje("danger","Hubo un error al guardar en la base de datos.", "panel/noticias");
            }
        }
    }
