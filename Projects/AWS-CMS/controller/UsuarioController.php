    ...
    public function editar($id){
        ...
        if (isset($_POST["usuario"])){
            ...
            if ($id == "nuevo"){
                ...
                $consulta = $this->db->exec("INSERT INTO usuarios (usuario, clave, noticias, usuarios) VALUES ('$usuario','$claveEncriptada',$noticias,$usuarios)");
                ...
                //actualiza el usuario en la db
                $consulta = $this->db->exec("UPDATE usuarios SET usuario='$usuario', clave='$claveEncriptada', noticias=$noticias, usuarios=$usuarios WHERE id='$id'");
