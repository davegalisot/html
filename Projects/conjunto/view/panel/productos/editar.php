<div class="container">
    <!--Cabecera e iconos-->
    <div class="row">
        <h3 class="col-9"><?php echo ($datos->id) ? "editar " : "crear " ?> producto</h3>
        <div class="col-3 iconos text-right">
            <a href="<?php echo $_SESSION['home'] ?>panel/productos" title="volver">
    ...
    <form method="POST" name="editar" action="<?php echo $_SESSION['home'] ?>panel/noticias/editar/<?php echo $id ?>" enctype="multipart/form-data">
        ...
        <div class="row edicion">
            <div class="col-6">
                ...
                <textarea name="nombre" rows="3"><?php echo $datos->nombre ?></textarea><br><br>
    ...
    <!-- <div class="imagen">
        ...
        <?php /*if (is_file($_SESSION['img'].$id.".jpg")){ ?>
            <img src="<?php echo $_SESSION['public']."img/".$id.".jpg?".date("s") ?>">
        <?php }*/ ?>
    </div>-->
</div>