    ...
    <header id="header">
        <div class="row">
            ...
            <div class="col-3 login text-right pr-5">
                <?php if (isset($_SESSION["usuario"])) { ?>
                    <p class="login">
                        Hola, <a class="login userBold" href="<?php echo $_SESSION["home"] ?>panel">
                            <?php echo $_SESSION["usuario"]->usuario ?></a>
                        <a class="login" href="<?php echo $_SESSION["home"] ?>panel/salir">(Salir)</a>
                    </p>
                <?php }else{ ?>
                    <a class="login" href="<?php echo $_SESSION["home"] ?>panel">Login</a>
                <?php } ?>
            </div>
        </div>
    </header>