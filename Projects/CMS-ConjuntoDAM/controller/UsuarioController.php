    ...
    public function editar($id){
        ...
        if (isset($_POST["usuario"])){
            ...
            if ($id == "nuevo"){
                ...
                $this->db->exec("UPDATE usuarios SET usuario='$usuario', clave='$claveEncriptada', productos=$productos, usuarios=$usuarios WHERE id='$id'") :
                $this->db->exec("UPDATE usuarios SET usuario='$usuario', productos=$productos, usuarios=$usuarios WHERE id='$id'");
