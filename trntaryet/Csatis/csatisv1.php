...
if (isset($_POST["enviar"])){
    ...
    if ($trabajo && $at_cli && $pla_en && $res_prob && $ase_tec && $conf && $prof && $cal_prod && $cal_ser){
        ...
        $_SESSION["escritura_db"] = "por favor, rellene todos los campos marcados de rojo";
        ...
        <footer id="footer" class="animated fadeIn">
            <div class="footer-flex width1500px mx-auto">
                ...
                <div class="footer-info">
                    <h4>Información</h4>
                    <a href="https://trntaryet.com/index.php/legal">Aviso legal</a>
                    <a href="https://trntaryet.com/index.php/privacidad">Política de privacidad</a>
                    <a href="https://trntaryet.com/index.php/cookies">Política de cookies</a>
                ...
                <div class="footer-mQ-576">
                    <div class="footer-isos footer-isos-mQ-576">
                        <img class="isos" src="../public/img/logos/logo-bureau-iso-transparente.png" alt="">
                        <a href="https://trntaryet.com/img/pdf/POLITICA-CALIDAD-TRNTARYET.pdf" target="_blank">Política de calidad</a>
                    </div>
